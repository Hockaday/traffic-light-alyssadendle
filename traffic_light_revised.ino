...
void setup() {
  // put your setup code here, to run once:
   pinMode(12, OUTPUT); // green 1 light
   pinMode(11, OUTPUT); // yellow 1 light
   pinMode(10, OUTPUT); // red 1 light
   pinMode(8, OUTPUT); // button 
   pinMode(7, OUTPUT); // green 2 light
   pinMode(6, OUTPUT); // yellow 2 light
   pinMode(5, OUTPUT); // red 2 light 
